		...
		<section className='contact'>
			...
			<div className='contact__content'>
				<a
					...
					<img src={ContactLogo} alt='Contact logo' className='contact__img' />
				...
				<a
					...
					className='contact__item'>
					<img src={CodepenLogo} alt='Codepen logo' className='contact__img' />
				...
				<a
					...
					className='contact__item'>
					<img src={TwitterLogo} alt='Twitter logo' className='contact__img' />
